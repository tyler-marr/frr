...
networks = set()        # used to check if first or 2nd link to a network

link_list = []          # list of all rtr-rtr links
...
class Router():
    ...
    def __init__(self, rtr):
        ...
        for link in rtr.links:
            ...
            subnet = 2 if network in networks else 1
            networks.add(network)
            self.interfaces.append(self.Interface(dev_n, network, subnet))
        print("router {} has {} interfaces".format(self.name, len(self.interfaces)))
...
class SegTopo(Topo):
    ...
    def produceRouterConfig(self, routers, zebraTemplate, ospfdTemplate):
    ...
    def build(self, *_args, **_opts):
        ...
        # create a host computer attached to r1 
        tgen.add_router("h1")
        self.connect("h1", "r1")
        ...
        self.connect("r9",  "r10")
        self.connect("r9",  "r12")
        self.connect("r10", "r11")
        self.connect("r10", "r12")
        self.connect("r11", "r12")
        ...
        self.produceRouterConfig(routers_list, zebraTemplate, ospfdTemplate)
